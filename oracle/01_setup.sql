...
-- SYSTEM PRIVILEGES
GRANT CREATE SESSION TO CMS WITH ADMIN OPTION;
GRANT CREATE TABLE TO CMS WITH ADMIN OPTION;
GRANT CREATE PROCEDURE TO CMS WITH ADMIN OPTION;
GRANT CREATE SEQUENCE TO CMS WITH ADMIN OPTION;
GRANT CREATE ANY TRIGGER TO CMS WITH ADMIN OPTION;
GRANT DROP ANY TRIGGER TO CMS WITH ADMIN OPTION;
GRANT CREATE ANY INDEX TO CMS WITH ADMIN OPTION;
GRANT DROP ANY INDEX TO CMS WITH ADMIN OPTION;
